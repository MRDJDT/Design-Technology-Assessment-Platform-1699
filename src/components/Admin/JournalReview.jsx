...
export default function AdminJournalReview() {
  ...
  const [journalEntries, setJournalEntries] = useState([
      ...
      teacher_responses: [
        {
          ...
          content: 'Excellent reflection Sarah! I can see you really understood the importance of constraints in CAD. Your enthusiasm for learning new tools is wonderful. Next time, try experimenting with different shapes!',
    ...
    {
      id: 3,
      title: 'Struggle with Circuits',
      content: 'Today we worked on electrical circuits and I found it really confusing. I kept getting the connections wrong and my bulb wouldn\'t light up. Everyone else seemed to get it but I felt lost. I don\'t think I\'m good at this.',
      subject: 'Design & Technology',
      mood: 'frustrated',
      tags: ['circuits', 'electricity', 'struggling'],
      images: [],
      ...
      teacher_responses: [],
      ai_feedback: {
        content: 'I can hear your frustration, and that\'s completely normal when learning something new and complex like circuits.',
        suggestions: ['Start with very simple circuits', 'Use circuit diagrams', 'Practice with a partner'],
          ...
          return (
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center">
                    <span className="text-blue-600 font-semibold text-sm">{entry.pupil.avatar}</span>
                  </div>
                  <div>
                    <h4 className="font-semibold text-gray-900">{entry.pupil.name}</h4>
                    <p className="text-sm text-gray-600">{entry.pupil.class}</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between text-xs text-gray-500">
                ...
                <div className="flex items-center space-x-2">
                  {entry.teacher_responses.length > 0 && (
                ...
                <div>
                  <div className="flex items-center space-x-3 mb-2">
                    <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center">
                      <span className="text-blue-600 font-semibold">{selectedEntry.pupil.avatar}</span>
                    </div>
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900">{selectedEntry.pupil.name}</h3>
                      <p className="text-gray-600">{selectedEntry.pupil.class}</p>
                    </div>
                  </div>
